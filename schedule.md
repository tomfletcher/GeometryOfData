...
| Mo 1/26 | *Snow Day!* | | |
| We 1/28 | Topology Basics cont. | [RGN](notes/RiemannianGeometryNotes.pdf) (Section 1) | |
...
| Mo 2/23 | Statistics on Manifolds: Principal Geodesic Analysis<br>[PCA Refresher](PCARefresher.pdf) | [Fletcher 2019, Section 3](https://canvas.its.virginia.edu/files/18157101/) | |
...
| We 3/18 | More Laplacian | | [HW 3](homeworks/hw3.pdf), Due Fri 4/3<br>[Autoencoder.ipynb](homeworks/Autoencoder.ipynb)<br>[teapot.pth (zipped)](https://canvas.its.virginia.edu/courses/168614/files/18872566/download?download_frd=1) |
| Mo 3/23 | Manifold geometry of neural networks<br>Immersions and Submersions | [Goodfellow et al. 2016, Chapter 14](https://www.deeplearningbook.org/) | |
...
| We 4/22 | Langevin and Hamiltonian Monte Carlo | [MALA](https://en.wikipedia.org/wiki/Metropolis-adjusted_Langevin_algorithm)<br>[HMC](https://arxiv.org/pdf/1206.1901)<br>[Riemannian MALA and HMC](https://www-jstor-org.proxy1.library.virginia.edu/stable/41057430) | [HW 5](homeworks/hw5.pdf), Due Th 5/7<br>[HW5-Starter.ipynb](homeworks/HW5-Starter.ipynb) |
| Mo 4/27 | Diffusion Models | [Denoising Diffusion Probabilistic Models](https://arxiv.org/abs/2006.11239)<br>[Score-based Generative Models](https://yang-song.net/blog/2021/score/) | |
